...
VkCommandBuffer EasyVulkanTextureManager::getCmdBuffer()
{
	return vkCmdBuffer;
}

VkPipeline EasyVulkanTextureManager::getPipeline()
{
	return vkPipeline;
}

VkPipelineLayout EasyVulkanTextureManager::getPipelineLayout()
{
	return vkPipelineLayout;
}

VkDescriptorSet* EasyVulkanTextureManager::getDescriptorSetPtr()
{
	return vkpDescriptorSet;
}

void EasyVulkanTextureManager::setPipeline(VkPipeline pipeline)
{
	vkPipeline = pipeline;
}

void EasyVulkanTextureManager::setPipelineLayout(VkPipelineLayout pipelineLayout)
{
	vkPipelineLayout = pipelineLayout;
}

void EasyVulkanTextureManager::setDescriptorSetPtr(VkDescriptorSet* vkpDescriptorset)
{
	EasyVulkanTextureManager::vkpDescriptorSet = vkpDescriptorset;
}

void EasyVulkanTextureManager::setImageLayout(VkCommandBuffer cmd, VkImage image, VkImageAspectFlags aspectMask, VkImageLayout old_image_layout, VkImageLayout new_image_layout)
{
